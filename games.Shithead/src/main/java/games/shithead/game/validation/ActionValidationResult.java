...
public enum ActionValidationResult {
    /**
     * The action is valid, and the played rank is accepted based on the pile contents.
     * Play should proceed as usual.
     */
    PROCEED,

    /**
     * The action is valid, but the played rank is not accepted based on the pile contents.
